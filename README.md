...
<img src="https://github.com/user-attachments/assets/e4d05fd1-7dcc-438b-9bfd-895ec29b494a" width="600" border="1" style="border: 4px solid #f00; margin: 20px;" />
...
* Custom set of credentials 🚧 (available in Ethora git repo)
* Apple SSO 🚧 (available in Ethora git repo)
* Facebook SSO 🚧 (available in Ethora git repo)
* Metamask SSO 🚧 (available in Ethora git repo)
...
* **Basic "initials" avatars** ✅ - in chat screen, users can see basic "initials" avatars next to chat bubbles. These avatars are generated by taking the first letter of User's first name and last name.
...
* **Profile Assets (Digital Wallet)** 🚧 (available in Ethora git repo) - Users can view assets (Documents, art/collectables, Coins) 
